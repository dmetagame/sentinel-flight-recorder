...
- `evidence/benchmark/anchor-tx.json` — BSC testnet anchor tx for the Merkle root: `0x3121857e2e10986e7e0be2c45a01c4481656485b76946270f1a34b0c0e7cd810`

The receipts are also served live at `GET /api/receipts` so the cockpit and any external auditor can pull the evidence with the Merkle root and on-chain anchor in one response.
